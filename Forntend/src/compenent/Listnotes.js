...
const people = [
  ...
  export default function Example() {
    return (
      ...
      <Navbar/>
        <div className="m-8 ">    
      <ul role="list" className="divide-y divide-gray-100  h-96 rounded-lg  overflow-x-hidden bg-slate-900">
        {people.map((person) => (
          <li key={person.email} className="flex justify-between gap-x-6 py-5 border-white">
